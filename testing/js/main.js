...
const selectedCity = citymap[Math.floor(Math.random() * citymap.length)]
    ...
    function initMap() {
        ...
        var map = new google.maps.Map(document.getElementById('map'), {
            ...
            zoom: (selectedCity.area <= 250) ? 13 : (selectedCity.area <= 350) ? 12 : (selectedCity.area <= 500) ? 10.25 : (selectedCity.area <= 750) ? 9.25 : (selectedCity.area <= 1000) ? 9 : 10.25,
